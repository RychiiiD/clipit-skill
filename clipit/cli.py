...
def cmd_splice(args):
    ...
    output_path = splice(args.videos, decisions, args.output, reorder=args.reorder)
...
def main():
    ...
    # splice
    p_s = sub.add_parser("splice", help="Splice video(s) by decisions JSON")
    p_s.add_argument("videos", nargs="+", help="Path(s) to video file(s)")
